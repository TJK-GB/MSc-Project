...
class AnnotationTool:
    ...
    def create_buttons(self):
        ...
        tk.Button(self.root, text="⏪ 1s Back", width=15, command=lambda: self.step_frame(-1)).grid(row=9, column=2)
        tk.Button(self.root, text="⏪ 5s Back", width=15, command=lambda: self.step_frame(-5)).grid(row=10, column=2)
        tk.Button(self.root, text="⏪ 10s Back", width=15, command=lambda: self.step_frame(-10)).grid(row=11, column=2)
        tk.Button(self.root, text="⏩ 1s Forward", width=15, command=lambda: self.step_frame(1)).grid(row=9, column=3)        
        tk.Button(self.root, text="⏩ 5s Forward", width=15, command=lambda: self.step_frame(5)).grid(row=10, column=3)        
        tk.Button(self.root, text="⏩ 10s Forward", width=15, command=lambda: self.step_frame(10)).grid(row=11, column=3)
